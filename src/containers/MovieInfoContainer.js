            ...
            <div className="movieInfoContainer">
              <Col xs={12} md={4}>
                ...
                <p>
                  ...
                  {this.starSymbol(this.props.movieData.vote_average)}
                </p>
                <p>
                  <span className="bold">Runtime: </span>
                  {this.props.movieData.runtime}mins
                </p>
                <p>
                ...
                <div className="emptySpace forDesktop" />
                <Button
              ...
              <Col xs={12} md={8}>
                <p className="trailerTitle bold">
                  {!this.props.videoData.name ? "" : this.props.videoData.name}
                </p>
                ...
                <div className="emptySpace forMobile" />
                <Button
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(
    { getMovieDetail, getVideo, getReview, saveMovie, getSavedMovie },
    dispatch
  );
}
